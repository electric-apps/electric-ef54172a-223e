...
## App Description
A local-first, real-time todo application where users can create, complete, and delete tasks. Changes sync instantly across all open tabs and devices via Electric SQL.
